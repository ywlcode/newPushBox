/********************************************************************************
** Form generated from reading UI file 'beginpage.ui'
**
...
#ifndef UI_BEGINPAGE_H
#define UI_BEGINPAGE_H
...
public:
    ...
    void setupUi(QWidget *BeginPage)
    {
        if (BeginPage->objectName().isEmpty())
            BeginPage->setObjectName(QString::fromUtf8("BeginPage"));
        BeginPage->resize(1600, 900);
        BeginPage->setMinimumSize(QSize(800, 450));
        BeginPage->setStyleSheet(QString::fromUtf8(""));
        gridLayout_6 = new QGridLayout(BeginPage);
        gridLayout_6->setSpacing(0);
        gridLayout_6->setContentsMargins(11, 11, 11, 11);
        gridLayout_6->setObjectName(QString::fromUtf8("gridLayout_6"));
        gridLayout_6->setContentsMargins(0, 0, 0, 0);
        frame_background = new QFrame(BeginPage);
        ...
        btn_1->setStyleSheet(QString::fromUtf8("color:#e83737;\n"
...
"border-radius: 10px;"));
        ...
        btn_2->setStyleSheet(QString::fromUtf8("color:#d7b105;\n"
"background-color:#ffffff;\n"
"border:none;\n"
"border-radius: 10px;"));
        ...
        btn_3->setStyleSheet(QString::fromUtf8("color:#7185ff;\n"
"background-color:#ffffff;\n"
"border:none;\n"
"border-radius: 10px;"));
        ...
        btn_4->setStyleSheet(QString::fromUtf8("color:#7bb7a5;\n"
"background-color:#ffffff;\n"
"border:none;\n"
"border-radius: 10px;"));
        ...
        btn_mini = new QPushButton(frame_background);
        btn_mini->setObjectName(QString::fromUtf8("btn_mini"));
        btn_mini->setMinimumSize(QSize(50, 45));
        btn_mini->setMaximumSize(QSize(50, 45));
        QFont font1;
        font1.setFamily(QString::fromUtf8("Arial Rounded MT Bold"));
        font1.setPointSize(22);
        btn_mini->setFont(font1);
        btn_mini->setFocusPolicy(Qt::NoFocus);
        btn_mini->setStyleSheet(QString::fromUtf8("background:#ffffff;\n"
"border:none;\n"
"border-radius: 20px;\n"
"color: #606060;"));

        horizontalLayout_12->addWidget(btn_mini);

        btn_exit = new QPushButton(frame_background);
        btn_exit->setObjectName(QString::fromUtf8("btn_exit"));
        btn_exit->setMinimumSize(QSize(50, 45));
        btn_exit->setMaximumSize(QSize(50, 50));
        QFont font2;
        font2.setFamily(QString::fromUtf8("Arial Rounded MT Bold"));
        font2.setPointSize(16);
        btn_exit->setFont(font2);
        btn_exit->setFocusPolicy(Qt::NoFocus);
        btn_exit->setStyleSheet(QString::fromUtf8("background:#ffffff;\n"
"border:none;\n"
"border-radius: 20px;\n"
"color: #606060;"));

        horizontalLayout_12->addWidget(btn_exit);
        ...
        lineE_user_name->setMinimumSize(QSize(0, 30));
        QFont font4;
        font4.setFamily(QString::fromUtf8("Arial"));
        font4.setPointSize(10);
        font4.setBold(false);
        font4.setWeight(50);
        lineE_user_name->setFont(font4);
        ...
        lineE_pwd->setMinimumSize(QSize(0, 30));
        QFont font5;
        font5.setFamily(QString::fromUtf8("Agency FB"));
        font5.setPointSize(10);
        lineE_pwd->setFont(font5);
        ...
        btn_forget->setFont(font6);
        btn_forget->setFocusPolicy(Qt::NoFocus);
        ...
        btn_wx->setFocusPolicy(Qt::NoFocus);
        btn_wx->setStyleSheet(QString::fromUtf8(""));
        ...
        btn_qq->setFocusPolicy(Qt::NoFocus);
        ...
        btn_wb->setFocusPolicy(Qt::NoFocus);
        ...
        retranslateUi(BeginPage);

        QMetaObject::connectSlotsByName(BeginPage);
    } // setupUi

    void retranslateUi(QWidget *BeginPage)
    {
        BeginPage->setWindowTitle(QApplication::translate("BeginPage", "Widget", nullptr));
        btn_1->setText(QApplication::translate("BeginPage", "\347\262\211\347\272\242", nullptr));
        btn_2->setText(QApplication::translate("BeginPage", "\350\223\235\351\273\204", nullptr));
        btn_3->setText(QApplication::translate("BeginPage", "\346\265\205\347\264\253", nullptr));
        btn_4->setText(QApplication::translate("BeginPage", "\351\235\222\347\273\277", nullptr));
        btn_mini->setText(QApplication::translate("BeginPage", "-", nullptr));
        btn_exit->setText(QApplication::translate("BeginPage", "X", nullptr));
        label_login->setText(QApplication::translate("BeginPage", "\346\216\250\347\256\261\345\255\220", nullptr));
        label_user_name->setText(QString());
        label_pwd->setText(QString());
        btn_forget->setText(QApplication::translate("BeginPage", "\346\262\241\346\234\211\350\264\246\345\217\267\357\274\237\347\202\271\346\255\244\346\263\250\345\206\214", nullptr));
        btn_login->setText(QApplication::translate("BeginPage", "\347\231\273\345\275\225", nullptr));
...
namespace Ui {
    class BeginPage: public Ui_BeginPage {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_BEGINPAGE_H
